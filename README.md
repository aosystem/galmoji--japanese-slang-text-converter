# Galmoji Text Converter 🌸🔡

A specialized text transformation tool built with **Flutter** that converts standard Japanese text into **"Galmoji"**—a creative internet slang that replaces characters with visually similar symbols, Greek letters, and Cyrillic characters.

[![Google Play](https://img.shields.io/badge/Google_Play-Download-green?logo=googleplay&logoColor=white)](https://play.google.com/store/apps/details?id=jp.aosystem.galmoji)
...
- **Framework:** Flutter
- **Language:** Dart
- **Logic:** Advanced string manipulation and dictionary-based character mapping for Japanese phonetic symbols.
- **Target Market:** Japan 🇯🇵
